...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> bookItem(long userId, BookingClientDto requestDto) {
    ...
    public ResponseEntity<Object> getForItemsBookings(Long userId, String state, int from, int size) {
        Map<String, Object> parameters = Map.of(
                "state", state,
                "from", from,
                "size", size
